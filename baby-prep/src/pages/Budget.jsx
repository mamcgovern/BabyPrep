...
function Budget() {
    ...
    const handleMarkPurchased = async (item) => {
        ...
        try {
            ...
            console.error('Error marking budget item purchased:', updateError);
        }
    };
        ...
        <div className="page budget-page">
            ...
            <div className="budget-summary-grid">
                ...
                <div className="budget-summary-card budget-summary-remaining">
                    ...
                    <small>{stats.planned} not purchased</small>
                </div>

                <div className="budget-summary-card budget-summary-gear">
                    <span>Baby Gear</span>
                    <strong>{stats.fromBabyGear}</strong>
                                ...
                                <div className="budget-card-main">
                                    ...
                                    {item.sourceType === 'babyGear' && (
                                        <div className="budget-connected">
                                            <span>Connected to Baby Gear</span>
                                            <Link to="/baby-gear">
                                                View gear ↗
                                            </Link>
                                        </div>
